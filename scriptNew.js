...
{birdName: 'Red Elderberry', sciName: 'Sambucus racemosa', paragraph1: 'Red Elderberry is native to Western Washington.  A variety of birds, including American Crows (pictured), <span class="sh" id="sh19">Band-tailed Pigeons</span>, <span class="sh" id="sh17">Pileated Woodpeckers</span>, and even Wood Ducks, as well as many other creatures, will eat these berries. Learn more about the Red Elderberry at the Native Plants of the PNW.', birdURL: 'http://nativeplantspnw.com/red-elderberry-sambucus-racemosa/', birdLinkText: 'Learn more about the Red Elderberry at the Native Plants of the PNW.', img: 'lifePictures/redElderberry.jpg'},
...
{birdName: 'Eight-spotted Skimmer', sciName: 'Libellula forensis', paragraph1: 'This dragonfly is a Western Washington native. Surprisingly, the largest predator for dragonflies around Union Bay may be our Great Blue Heron which can weigh as much as 5 pounds and is still able to snatch dragonflies out of the air.', birdURL: '', birdLinkText: '', img: 'lifePictures/dragonfly.jpg'},
...
{birdName: 'Vine Maple', sciName: 'Acer Circinatum', paragraph1: 'The Vine Maple is native to Western Washington and often fills in the understory below our more stately Firs, Hemlocks, and Cedars. This maple is sometimes used by Native Americans for weaving baskets. Stellars Jay\'s enjoy the seeds of the Vine Maple.', birdURL: 'http://nativeplantspnw.com/vine-maple-acer-circinatum/', birdLinkText: 'Learn more about the Vine Maple at the Native Plants of the PNW', img: 'lifePictures/vineMaple.jpg'},
